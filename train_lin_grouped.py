...
"""
    ...
    while global_step < args.total_timesteps:
        ...
        # rb.add(board[0], next_board[0], actions[0], rewards[0], terminations[0], infos)
        ...
        if global_step > args.learning_starts:
            if global_step % args.train_frequency == 0:
                ...
                if global_step % 100 == 0:
                    ...
                    if loss > best_loss:
                        best_loss = loss
                        torch.save(q_network.state_dict(), f"runs/{run_name}/best.pt")
        ...
        if args.save_model or global_step % 50000 == 0:
