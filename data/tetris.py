...
class Tetris:
    ...
    def restart(self, board, ind, current_pos=None):
        # self.board = board
        self.score = 0
        self.tetrominoes = 0
        self.cleared_lines = 0
        ...
        if ind == 0: print("Got Square")
        if ind == 1: print("Got Tee")
        if ind == 2: print("Got Ess")
        if ind == 3: print("Got Zee")
        if ind == 4: print("Got Line")
        if ind == 5: print("Got El")
        if ind == 6: print("Got Jay")
